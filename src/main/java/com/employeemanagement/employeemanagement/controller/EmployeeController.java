...
public class EmployeeController {
	...
	public @ResponseBody ResponseEntity<?> getAll(@RequestBody EmployeeFilterDTO employeeFilter) {
		try {
			List<EmployeeDTO> employeeListDTO = getEmployeeService().getAll(employeeFilter);
